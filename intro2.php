...
　</tr>
        ...
        <h3>注意事項</h3>
        <ul class="note">
            <li>速く反応ができるようにするために、パソコンで実施する場合、「←」と「→」のキーの上に予め人差し指を置いて下さい。</li>
            <li>画面上部に示されている2つのラベルは、それぞれのキーがどちらの単語あるいは画像に対応しているのかを表しています。</li>
            <li>見えやすいようにモニターでの明るさ設定を最大にして下さい。</li>
        </ul>
    </div>
