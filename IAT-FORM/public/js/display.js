$(function () {
    ...
    var words = [
        ['嬉しさ', '愛情', '平和', '素晴らしい', '楽しみな', '苦悩', 'ひどい', '恐ろしい', '失敗', '邪悪な'],
        ['嬉しさ', '愛情', '平和', '素晴らしい', '楽しみな', '苦悩', 'ひどい', '恐ろしい', '失敗', '邪悪な', '補聴器', '手話', '筆談', '聴覚障害', '聞こえない'],
        ['嬉しさ', '愛情', '平和', '素晴らしい', '楽しみな', '苦悩', 'ひどい', '恐ろしい', '失敗', '邪悪な', '補聴器', '手話', '筆談', '聴覚障害', '聞こえない'],
        ['嬉しさ', '愛情', '平和', '素晴らしい', '楽しみな', '補聴器', '手話', '筆談', '聴覚障害', '聞こえない', '手話', '苦悩', 'ひどい', '恐ろしい', '失敗', '邪悪な'],
        ['嬉しさ', '愛情', '平和', '素晴らしい', '楽しみな', '補聴器', '手話', '筆談', '聴覚障害', '聞こえない', '手話', '苦悩', 'ひどい', '恐ろしい', '失敗', '邪悪な']
    ];
    var ans = [
