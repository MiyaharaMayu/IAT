                ...
                <h1>単語の分類(約5分)
                        ...
                        <div class="description">
                            ...
                            <div class ="text-center">
                                <img class="img-sp" src="{{ Storage::url('public/images/intro1.png') }}">
                                <img class="img-md" src="{{ Storage::url('public/images/intro1.png') }}">
                                </div>
                            <!--<table border="1">
                                <tr>
                                    <th>グループ</th>
                    ...
                    <div class ="text-center">
                    <img class="img-sp" src="{{ Storage::url('public/images/intro.png') }}">
                    <img class="img-md" src="{{ Storage::url('public/images/intro.png') }}">
                    </div>
